...
/**
 * Description:
 * This test case verifies that the user can login fail with invalid email
 */
...
'Step 2'
'Input Invalid Email with missing an @'
LoginPage.inputEmail('123test')
PageActions.sendKeys(findTestObject('Object Repository/LoginPage/txtEmail'), "enter"))
'Expected Result: '
PageActions.
